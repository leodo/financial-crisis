...
|---|---|---|---|---|
| P0 | FRED | `1990` 为统一日频基线；核心代理能更早则全量 | 日/周/月/季 | 美国核心风险指标 |
...
- `1990` 是因为 `VIX` 和 Treasury 日频曲线从这一段开始更适合做统一主面板。
- `1987` 这类更早场景不是排除，而是进入“扩展场景回填”，优先补充 `FEDFUNDS / BAA10Y / DEXJPUS / 月频利率代理` 等可用特征。
