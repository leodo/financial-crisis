...
- `apps/worker/src/probability/overlay.rs` 已继续收走 family overlay 的 audit spec、样本筛选、family-aware/balanced split 与 overlay 训练，`probability.rs` 开始回到“主头训练 + 阈值/评估”边界；
