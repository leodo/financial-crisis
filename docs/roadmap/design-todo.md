...
自 2026-06-02 起，工程结构、模块边界、共用逻辑收敛和生成工件治理，统一由 [工程维护性 TODO](engineering-maintainability-todo.md) 管理；该清单不替代危机概率主线 TODO，而是约束代码如何继续演进而不失控。

自 2026-06-04 起，本文档明确降级为“历史索引”：

- 不再新增当前活跃主线任务；
- 若需要新增当前任务，只允许写入上述两份活跃 TODO；
- 本文档只保留第一阶段设计导航和归档说明。
