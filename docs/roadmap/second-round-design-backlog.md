...
注意：本清单主要描述第一阶段“风险强度看板 + 基础数据层”的细分设计。自 2026-05-30 起，系统目标已经升级为“危机概率评估系统”，相关新增设计请优先查看 [危机概率评估设计 TODO](crisis-probability-design-todo.md)。

自 2026-06-04 起，本文档只保留“历史 backlog / 已完成细分设计清单”角色，不再承载当前活跃开发任务。
