...
cp "$REPO_DIR/deploy/formal-candidate-audit-pack.sh" "$ROOT/deploy/"
...
chmod +x "$ROOT/deploy/operational-check.sh" "$ROOT/deploy/smoke-check.sh" "$ROOT/deploy/formal-dataset-summary-pack.sh" "$ROOT/deploy/formal-candidate-audit-pack.sh" "$ROOT/deploy/sqlite-backup.sh" "$ROOT/deploy/sqlite-restore.sh" "$ROOT/deploy/sqlite-drill.sh"
repair_runtime_permissions
