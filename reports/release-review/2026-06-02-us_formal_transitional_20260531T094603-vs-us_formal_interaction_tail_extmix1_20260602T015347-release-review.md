...
- Reviewed at: 2026-06-02T02:15:19.020750+00:00
...
| candidate | us_formal_interaction_tail_extmix1_20260602T015347 | formal_bundle_v1 | best_effort | feature_formal_v1_main_20260531 | formal_label_v1_main | approved |
...
- Release: us_formal_interaction_tail_extmix1_20260602T015347
- History points: 15152
...
- Thresholds: prepare_p60d=68.9%, hedge_p20d=43.1%, defend_p5d=5.0%
- Runtime policy version: runtime_history_v1_20260601|class=formal_main|prepare=0.689|hedge=0.431|defend=0.050
- Probability floor hits: p_60d>=prepare 2406 / p_20d>=hedge 1308 / p_5d>=defend 2661
...
| --- | --- | --- | --- |
| prepare | prepare_carry_structural | 375 | 81.9% |
| prepare | prepare_p60d_structural | 261 | 57.0% |
| prepare | prepare_structural_downgrade | 212 | 46.3% |
| hedge | hedge_p20d_context | 109 | 100.0% |

| Horizon | Early regime | Normal P | Positive-window P | Cooldown P | Early raw lift | Early calibrated lift | Positive-window lift | Cooldown lift | Gap retention | Diagnosis |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5d | positive_window | 3.9% | 3.8% | 1.4% | 0.97x | 0.97x | 0.97x | 0.36x | 1.00 | weak_regime_separation |
| 20d | pre_warning_buffer | 11.7% | 18.4% | 9.7% | 1.53x | 1.38x | 1.58x | 0.83x | 0.81 | usable_early_warning_separation |
| 60d | pre_warning_buffer | 25.5% | 38.6% | 33.2% | 1.01x | 0.90x | 1.52x | 1.30x | -12.47 | usable_early_warning_separation |

| Horizon | Regime | Rows | Share | Avg raw P | Max raw P | Avg calibrated P | Max calibrated P | Raw lift vs normal | Calibrated lift vs normal | Gap retention | Floor hits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5d | in_crisis | 826 | 5.5% | 1.7% | 68.0% | 1.7% | 68.0% | 0.43x | 0.43x | 1.00 | 67 |
| 5d | normal | 14261 | 94.1% | 3.9% | 89.0% | 3.9% | 89.0% | 1.00x | 1.00x | — | 2586 |
| 5d | positive_window | 15 | 0.1% | 3.8% | 9.7% | 3.8% | 9.7% | 0.97x | 0.97x | 1.00 | 5 |
| 5d | post_crisis_cooldown | 42 | 0.3% | 1.4% | 4.6% | 1.4% | 4.6% | 0.36x | 0.36x | 1.00 | 0 |
| 5d | pre_warning_buffer | 8 | 0.1% | 13.4% | 33.2% | 13.4% | 33.2% | 3.40x | 3.40x | 1.00 | 3 |
| 20d | in_crisis | 836 | 5.5% | 25.8% | 99.9% | 25.7% | 93.0% | 2.50x | 2.20x | 0.91 | 159 |
| 20d | normal | 14125 | 93.2% | 10.3% | 99.3% | 11.7% | 93.0% | 1.00x | 1.00x | — | 1139 |
| 20d | positive_window | 60 | 0.4% | 18.0% | 55.0% | 18.4% | 55.0% | 1.74x | 1.58x | 0.88 | 5 |
| 20d | post_crisis_cooldown | 90 | 0.6% | 9.4% | 35.6% | 9.7% | 35.6% | 0.91x | 0.83x | 2.30 | 0 |
| 20d | pre_warning_buffer | 41 | 0.3% | 15.7% | 45.0% | 16.1% | 45.0% | 1.53x | 1.38x | 0.81 | 5 |
| 60d | in_crisis | 836 | 5.5% | 15.3% | 93.6% | 33.3% | 93.0% | 0.67x | 1.31x | -1.05 | 128 |
| 60d | normal | 13971 | 92.2% | 22.7% | 100.0% | 25.5% | 93.0% | 1.00x | 1.00x | — | 2173 |
| 60d | positive_window | 180 | 1.2% | 37.0% | 93.7% | 38.6% | 93.0% | 1.63x | 1.52x | 0.92 | 60 |
| 60d | post_crisis_cooldown | 135 | 0.9% | 29.5% | 90.9% | 33.2% | 90.9% | 1.30x | 1.30x | 1.15 | 45 |
| 60d | pre_warning_buffer | 30 | 0.2% | 22.9% | 29.7% | 22.9% | 29.7% | 1.01x | 0.90x | -12.47 | 0 |
...
| actionable_precision | 0.0% | 63.8% | +63.8pp |
| longest_false_positive_episode_days | 0 | 21 | +21 |
...
- longest_false_positive_episode_days increased from 0 to 21
