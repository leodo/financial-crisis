...
pub(crate) const FORMAL_MAIN_TREND_FEATURE_SET_PREFIX: &str = "feature_formal_v1_trend";
...
pub(crate) fn is_formal_main_feature_set(feature_set_version: &str, label_version: &str) -> bool {
    label_version == FORMAL_MAIN_LABEL_VERSION
        && [
            FORMAL_MAIN_FEATURE_SET_PREFIX,
            FORMAL_MAIN_TREND_FEATURE_SET_PREFIX,
        ]
        .iter()
        .any(|prefix| feature_set_version.starts_with(prefix))
}
