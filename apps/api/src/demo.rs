...
use fc_domain::{
    ...
    AlertType, BacktestRollingAudit, BacktestRollingAuditEpisode, BacktestScenarioSummary,
    BacktestSignalSource, BacktestWindowPoint, DataMode, DataSource, DecisionPosture, Frequency,
    Indicator, Observation, PredictionSnapshotRecord, ProtectedStressWindow, RiskContributor,
...
pub(crate) use crate::history_replay::{
    ...
    historical_replay_point_draft_from_assessment, is_formal_main_release,
    load_cached_historical_replay_output, merge_historical_outputs,
    persist_historical_replay_output, prediction_snapshot_from_assessment,
    should_refresh_full_release_history, HistoricalAssessmentOutput,
};
use crate::AppData;
