...
use super::{
    ...
    decision::{
        ...
        probability_threshold_decision_metrics, probability_threshold_repair_candidate_diagnostics,
        regime_aware_threshold_prediction_ceiling, threshold_has_usable_early_warning_support,
        threshold_has_usable_forward_crisis_support,
    },
...
pub(crate) fn build_probability_threshold_diagnostics(
    ...
    ProbabilityThresholdDiagnosticsWire {
        ...
        repair_candidate_diagnostics: probability_threshold_repair_candidate_diagnostics(
            base_threshold,
            probabilities,
            labels,
            &threshold_selection.rows,
