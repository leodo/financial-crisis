...
#[test]
fn probability_guardrails_allow_zero_positive_and_cooldown_threshold_hits() {
    let regime_summary = RegimeSeparationEvaluationSummary {
        horizon_days: 20,
        early_warning_regime: "pre_warning_buffer".to_string(),
        normal_sample_count: 50,
        pre_warning_buffer_sample_count: 10,
        positive_window_sample_count: 20,
        early_warning_sample_count: 10,
        in_crisis_sample_count: 10,
        post_crisis_cooldown_sample_count: 45,
        normal_avg_probability: 0.03,
        pre_warning_buffer_avg_probability: 0.18,
        positive_window_avg_probability: 0.52,
        early_warning_avg_probability: 0.18,
        in_crisis_avg_probability: 0.60,
        post_crisis_cooldown_avg_probability: 0.23,
        max_non_normal_avg_probability: 0.60,
        pre_warning_buffer_lift_vs_normal: Some(6.0),
        positive_window_lift_vs_normal: Some(17.333),
        early_warning_lift_vs_normal: Some(6.0),
        in_crisis_lift_vs_normal: Some(20.0),
        post_crisis_cooldown_lift_vs_normal: Some(7.667),
        positive_window_gap_vs_normal: Some(0.49),
        post_crisis_cooldown_gap_vs_normal: Some(0.20),
        max_non_normal_lift_vs_normal: Some(20.0),
        regime_tail_diagnostics: BTreeMap::new(),
        diagnosis: "usable_early_warning_separation".to_string(),
    };
    let horizon_bundle = ProbabilityHorizonBundle {
        horizon_days: 20,
        decision_threshold: Some(0.005),
        threshold_diagnostics: Some(ProbabilityThresholdDiagnostics {
            label_mode: "forward_crisis".to_string(),
            early_warning_regime: "pre_warning_buffer".to_string(),
            full_calibration_row_count: 100,
            ...
            repair_applied: false,
            repair_eligible: true,
            repair_reason: "base_hits_early_warning_but_no_positive_window_hits".to_string(),
            early_warning_probability_cap: Some(0.20),
            prediction_ceiling: Some(100),
            relaxed_prediction_ceiling: Some(300),
            base_summary: ProbabilityThresholdDecisionSummary {
                predicted_positive_count: 402,
                true_positive_count: 0,
                precision: 0.0,
                recall: 0.0,
                early_warning_row_count: 481,
                early_warning_hit_count: 137,
                early_warning_hit_rate: 0.285,
                normal_row_count: 50,
                normal_hit_count: 0,
                normal_hit_rate: 0.0,
                positive_window_row_count: 20,
                positive_window_hit_count: 0,
                positive_window_hit_rate: 0.0,
                in_crisis_row_count: 10,
                in_crisis_hit_count: 0,
                in_crisis_hit_rate: 0.0,
                cooldown_row_count: 45,
                cooldown_hit_count: 0,
                cooldown_hit_rate: 0.0,
            },
            final_summary: ProbabilityThresholdDecisionSummary {
    ...
    let bundle = ProbabilityBundle {
        bundle_id: "candidate_guard_threshold_zero_hits".to_string(),
        market_scope: "financial_system".to_string(),
        probability_mode: "formal_bundle_v1".to_string(),
        model_family: PROBABILITY_MODEL_FAMILY_LINEAR_V1.to_string(),
        feature_transform: PROBABILITY_FEATURE_TRANSFORM_IDENTITY_V1.to_string(),
